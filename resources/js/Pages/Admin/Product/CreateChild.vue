        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">
                        Создать дочерний товар
                    </h1>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Добавьте новую вариацию товара
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div v-if="product.images && product.images.length > 0" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 sticky top-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Изображения родительского товара</h3>
                        <div class="space-y-3">
                            <div v-for="image in product.images" :key="image.id" class="relative rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
            ...
            <!-- Success Message -->
            <div v-if="success">
                <WindowSuccessMessage :message="'Дочерний товар успешно создан'"/>
            </div>
        </div>
    </div>
</template>
